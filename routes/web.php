...
Route::get('/admin/laporan', [LaporanController::class, 'index']); //ini untuk menampilkan halaman
Route::get('/admin/laporan/barang', [LaporanController::class, 'cetak_barang']); //ini untuk mencetak barang
